...
namespace R3MUS.Devpack.NAGA.Models
{
        ...
        public bool IsValid()
        {
            ...
            try
            {
                ...
                foreach (ApiInfo apiInfo in this.ApiKeys)
                {
                    ...
                    if (clientAllianceId == hostAllianceID)
                    {
    ...
    public class ApiInfo
    {
        ...
        {
            bool result = false;
            long allianceAccessMask = Properties.Settings.Default.RequiredAccessMask;

            try
            {
                var mask = AccessMask;

                if (type == ApplicationUser.IDType.Alliance)
                {
    ...
    {
        public System.Data.Entity.DbSet<ApiInfo> ApiInfoes { get; set; }
